...
"""
#将DOTA官网下载的数据集和标签按照train{images；labels}格式储存
# 分割test集应用 SplitOnlyImage_multi_process.py
import os
import codecs
import numpy as np
import math
...
class splitbase():
    ...
    def SplitSingle(self, name, rate, extent):
        ...
        print("Images to process:", imagelist)  # 打印所有图片的完整路径
        print("Base names:", imagenames)  # 打印处理的图片名
